...
for T in temps:
    for i in range(len(names)):
        ...
        D = Diffuse(
            ...
            dump='/Users/adelle/Documents/ignition_calculations/kepler/run7/h#202',
...
for i in range(len(sizes)):
    names.append(f'run7_HS_size_{sizes[i]}')
...
names = []
for i in range(len(sizes)):
    names.append(f'run7_HS_size_{sizes[i]}_cart')
