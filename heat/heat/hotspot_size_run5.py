...
#names = ['run5_HS_size_1cm','run5_HS_size_1m','run5_HS_size_5m','run5_HS_size_10m','run5_HS_size_100m', 'run5_HS_size_300m', 'run5_HS_size_1km', 'run5_HS_size_1.5km','run5_HS_size_2km']
names = ['run5_nohotspot']
