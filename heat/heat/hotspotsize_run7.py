...
names = ['run7_HS_size_1cm','run7_HS_size_1m', 'run7_HS_size_5m', 'run7_HS_size_10m', 'run7_HS_size_100m', 'run7_HS_size_300m', 'run7_HS_size_1km', 'run7_HS_size_1.5km', 'run7_HS_size_2km']
temps =[1e8, 5e7]
